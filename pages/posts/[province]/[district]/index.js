...
export async function getServerSideProps(props) {
    ...
    return { props: { posts: posts, total, province: params.province, district: params.district } };
}
...
function Home(props) {
    ...
    const getLocal = async () => {
        ...
        if (getLocal) {
            ...
            const district = province.districts.find(nDistrict => convertChar(nDistrict.name).toLowerCase() === props.district);
